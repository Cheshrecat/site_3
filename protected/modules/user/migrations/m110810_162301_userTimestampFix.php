	...
	public function safeUp()
	{
        ...
        switch ($this->dbType()) {
            ...
            default:
                    ...
                    $this->createTable(Yii::app()->tableUses, array(
                        "id" => "pk",
                        "username" => "varchar(20) NOT NULL",
                        "password" => "varchar(128) NOT NULL",
                        "email" => "varchar(128) NOT NULL",
                    ...
                    $this->execute('INSERT INTO "'.Yii::app()->tableUser.'" SELECT "id","username","password","email","profile" FROM "'.__CLASS__.'_'.Yii::app()->tableUser.'"');
                    $this->dropTable(__CLASS__.'_'.Yii::app()->getModule('user')->tableUsers);
                    $this->dropTable(__CLASS__.'_'.Yii::app()->tableUser);
                break;
        }
	}
	...
	public function safeDown()
	{
        ...
        switch ($this->dbType()) {
            ...
            default:
                ...
                $this->createTable(Yii::app()->ableUser, array(
                    "id" => "pk",
                    "username" => "varchar(20) NOT NULL",
                    "password" => "varchar(128) NOT NULL",
                    "email" => "varchar(128) NOT NULL",
                ...
                $this->execute('DROP TABLE "'.__CLASS__.'_'.Yii::app()->tableUser.'"');
                break;
        }
	}
